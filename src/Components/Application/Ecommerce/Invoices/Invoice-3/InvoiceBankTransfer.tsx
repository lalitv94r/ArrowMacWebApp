        ...
        <tbody>
          <tr style={{ display: "flex", justifyContent: "space-between", margin: "28px 0", alignItems: "center" }}>
            <td>
              ...
              <h4 style={{ fontWeight: 600, margin: "12px 0 5px 0", fontSize: 18, color: "#43B9B2" }}>Leslie Alexander</h4>
              <span style={{ display: "block", lineHeight: "1.5", fontSize: 18, fontWeight: 400 }}>{BankAccount} : 0981234098765</span>
              <span style={{ lineHeight: "1.6", fontSize: 18, fontWeight: 400 }}>{Code} : LEF098756</span>
            </td>
            <td>
              <span style={{ fontSize: 16, fontWeight: 600, opacity: "0.8" }}>{TotalAmount}</span>
              <h4 style={{ fontWeight: 600, margin: "12px 0 5px 0", fontSize: 26, color: "#43B9B2" }}>$175.00</h4>
