import { ChatsHeading, Contacts } from "@/Constant";
  ...
  return (
    <div className="advance-options">
      <Nav tabs className="border-tab" id="chat-options-tab">
        <NavItem><NavLink className={`${activeTab === "1" ? "active" : ""}`} onClick={() => setActiveTab("1")} id="chats-tab">{ChatsHeading}</NavLink></NavItem>
