...
import { CreateTagProp } from "@/Type/Application/Tasks/TaskType";
        ...
        <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(AddTag)}>
          <Row>
            ...
            <Col md="12" className="mt-0">
              ...
              <input className={`form-color d-block  ${validation && `${errors.color ? "is-invalid" : "is-valid"}`}`} type="color" {...register("color", { required: true })} defaultValue="#43B9B2" />
            </Col>
          </Row>
