...
import { AddNewBookMarkInterFace } from "@/Type/Application/Bookmark/BookmarkType";
          ...
          <Row>
            ...
            <Col md="6">
              <FormGroup>
                ...
                <Input type="select" name="group" className="form-control js-example-basic-single"><option value="My Bookmark">My Bookmarks</option></Input>
              </FormGroup>
            </Col>
            <Col md="6">
              <FormGroup>
                <Label check>{Collection}</Label>
                <Input type="select" name="collection" className="form-control js-example-disabled-results"><option value="General">General</option><option value="Fs">Fs</option></Input>
              </FormGroup>
            </Col>
          </Row>
