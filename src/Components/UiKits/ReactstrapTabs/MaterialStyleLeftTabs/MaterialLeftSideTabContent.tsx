          ...
          <CardBody className="p-0">
            <div className="main-inbox"> 
              ...
              <div className="body-inbox mt-2">
                <div className="body-h-wrapper"><SvgIcon className='feather me-2 tab-space' iconId='star'/><em>Compare Prices Find the Best Computer Assessors Fronted Issue.</em></div>
