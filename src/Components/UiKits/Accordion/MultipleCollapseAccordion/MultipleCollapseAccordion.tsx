...
import { multipleData } from '@/Data/UiKits/Accordion/Accordion';
      ...
      <Card>
        ...
        <CardBody>
          <div className="common-flex">
            ...
            <Button color="secondary" onClick={toggleSecond}>{ToggleSecondElement}</Button>
            <Button color="tertiary" onClick={toggleBoth}>{ToggleBothElement}</Button>
          </div>
          <Row className="d-flex">
            ...
            <Col xl="6">
              <Collapse isOpen={openSecond} className="multi-collapse dark-accordion">
                <Card color="light-secondary" className="mt-3 mb-0 collapse-wrapper txt-dark">
