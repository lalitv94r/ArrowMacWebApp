...
const FullScreenBelowMd = () => {
    ...
    return <CommonFullScreenData color="success" onClick={fullScreenMdToggle} title={FullScreenBelowMD} fullscreen="md" isOpen={fullScreenMd} toggle={fullScreenMdToggle} />;
}
