...
const BothSideVisibleScrollbar = () => {
  return (
    <Col xl="6">
      <Card>
        <CardHeaderCommon title={BothSideVisibleScrollbars} span={bothSideScrollData} headClass='pb-' />
        <CardBody>
          <div className="scroll-bar-wrap">
            <ScrollBar className="scroll-demo" style={{width:"100%", height:"300px"}}>
              <div className="horz-scroll-content scroll-content-width">
                <Row>
                  <Col sm="3">
                    <div className="visible-wrapper"><Image width={330} height={330} src={`${ImagePath}/banner/2.jpg`} alt="office-work" /></div>
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><Image width={330} height={330}  src={`${ImagePath}/email/3.jpg`} alt="office" /></div>
                  </Col>
                  <Col sm="3">
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><Image width={330} height={330}  src={`${ImagePath}/banner/3.jpg`} alt="website" /></div>
