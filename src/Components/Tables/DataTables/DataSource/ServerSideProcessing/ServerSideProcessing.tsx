        ...
        <Card>
          ...
          <CardBody>
            <div className="table-responsive">
              <DataTable data={filteredItems} className='custom-scrollbar' columns={serverColumn} striped highlightOnHover pagination subHeader subHeaderComponent={subHeaderComponentMemo} />
            </div>
          </CardBody>
        </Card>
      </Col>
