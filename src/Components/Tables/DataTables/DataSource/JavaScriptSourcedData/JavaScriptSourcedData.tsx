        ...
        <Card>
          ...
          <CardBody>
            <div className="table-responsive">
              <DataTable data={filteredItems} className='custom-scrollbar' columns={javaScriptSourceColumn} striped highlightOnHover pagination subHeader subHeaderComponent={subHeaderComponentMemo} />
            </div>
          </CardBody>
        </Card>
      </Col>
