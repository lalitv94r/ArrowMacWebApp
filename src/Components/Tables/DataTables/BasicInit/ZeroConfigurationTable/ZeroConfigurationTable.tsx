      ...
      <Col sm="12">
        <Card>
          <CardHeader className="pb-0 card-no-border">
            <h4 className='mb-2'>{ZeroConfiguration}</h4>
          ...
          <CardBody>
            <DataTable columns={zeroConfigurationColumn} data={filteredItems} pagination subHeader subHeaderComponent={subHeaderComponentMemo} highlightOnHover striped persistTableHead responsive />
          </CardBody>
        </Card>
      </Col>
    );
