...
const ButtonsWithPrefixAndPostfix = () => {
    ...
    return (
      <Col xl="6">
        <Card>
          <CommonCardHeader title={ButtonsWithPrefixAndPostfixs} span={touchSpinData} headClass='pb-0' />
          <CardBody className="common-flex pre-post-touchspin bg-touchspin">          
            <InputGroup>
              ...
              <Button color="warning" outline id="button-addon1" className="px-2">{PreText}</Button>
            ...
            <InputGroup>
              ...
              <Button color="warning" outline id="button-addon2" className="px-2">{PostText}</Button>
