...
import { AadharPlaceholder, AboveInformationCorrect, CVVNumber, CardNumber, Expiration, ExpiryPlaceholder, PlaceHolderName, PlaceholderName, UploadDocumentation } from '@/Constant';
