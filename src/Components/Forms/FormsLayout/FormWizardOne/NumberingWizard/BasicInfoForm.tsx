...
import { AgreeToTermsAndConditions, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, FirstName, EdminMail, Password } from '@/Constant';
import { NumberingWizardPropsType } from '@/Type/Forms/FormsLayout/FormsLayout';
        ...
        <Row>
          <Col sm="6">
            <FormGroup>
              ...
              <Input onChange={getUserData} value={email} name="email" type="email" placeholder={EdminMail} />
            </FormGroup>
          </Col>
          <Col sm="6">
            <FormGroup>
          ...
          <Col xs="12">
            <FormGroup>  
              <Label check>{ConfirmPassword}<span className="font-danger">*</span></Label>
