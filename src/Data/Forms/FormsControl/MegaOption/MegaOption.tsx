export const variationRadioData = [
  ...
  export const solidBorderStyleData = [
    {
      text: "Use the ",
      code: ".default-border-style-*.mega-inline-*",
    },
    {
      text: "you can archive this style.",
    },
  ...
  export const inlineStyeDataList = [
    ...
    },
    {
      ...
      badgeTitle: "Standard",
      digits: "80 INR",
      shippingText: "Estimated 3 Day Shipping ( Duties end taxes may be due upon delivery )",
    },
    {
      id: 4,
      color: "warning",
      badgeTitle: "Local",
      digits: "Free",
      shippingText: "Estimated 15 Day Shipping ( Duties end taxes may be due upon delivery )",
    },
  ];
      ...
      child: [
        {
          ...
          digits: "250 INR",
          check: true,
          spanClass: "p-20 pt-0 rating-star-wrapper",
          star: [
            { id: 1, starClass: "font-warning" },
            { id: 2, starClass: "font-warning" },
            { id: 3, starClass: "font-warning" },
            { id: 4, starClass: "font-warning" },
            { id: 5, starClass: "font-warning m-r-5" },
          ],
        ...
        },
        {
          ...
          digits: "150 INR",
          spanClass: "p-20 pt-0 rating-star-wrapper",
          star: [{ id: 1, starClass: "font-warning" }, { id: 2, starClass: "font-warning" }, { id: 3 }, { id: 4 }, { id: 5, starClass: "m-r-5" }],
      ...
      child: [
        {
          ...
          badgeTitle: "Pixelstrap",
          digits: "250 INR",
          spanClass: "rating-star-wrapper p-20 pt-0",
          star: [
