...
import DismissibleAlerts from "@/Components/Tables/ReactstrapTable/TableComponent/Common/DismissibleAlerts";
import AlertsWithIcons from "@/Components/Tables/ReactstrapTable/TableComponent/Common/AlertsWithIcons";
import Link from "next/link";

export const uiComponentData = [
  {
    title: "Button",
    tableColData: <Button color="primary">{"Default Button"}</Button>,
    details: [
      {
    ...
    tableColData: (
      <Alert color="primary">
        <p>
          ...
          <Link className="alert-link" href={Href}>
            {" "}
            read this message
          </Link>
          .
...
export const checkBoxTableData = [
  {
    ...
    tableColData: (
      <>
        ...
        <Label for="checkbox1" className="ms-2">Default</Label>
      </>
    ),
    details: [
      {
  ...
  },
  {
    ...
    tableColData: (
      <FormGroup className="m-b-0">
        <Label for="checkbox-state-dark" className="d-inline-block me-3">
          <Input className="checkbox-dark checkbox-border-dark" id="checkbox-state-dark" type="checkbox" />
          Brand state
        </Label>
      </FormGroup>
    ),
  ...
  },
  {
    ...
    tableColData: (
      <FormGroup className="m-b-0">
        <Label for="inline-1" className="d-inline-block me-3">
          <Input id="inline-1" type="checkbox" className="checkbox-primary checkbox-border-primary" />
          Option 1
        </Label>
        <Label for="inline-2" className="d-inline-block me-3">
          <Input id="inline-2" type="checkbox" className="checkbox-secondary checkbox-border-secondary" />
          Option 1
        </Label>
        <Label for="inline-3" className="d-inline-block me-3">
          <Input id="inline-3" type="checkbox" className="checkbox-tertiary checkbox-border-tertiary" />
          Option 1
        </Label>
      </FormGroup>
    ),
...
export const radioBoxTableData = [
  {
    ...
    tableColData: (
      <>
        ...
        <Label for="radio"  className="ms-2">Default radio</Label>
      </>
    ),
    details: [
      {
  ...
  },
  {
    title: "Default Radio",
    tableColData: (
      <FormGroup className="m-b-0 d-flex">
        <Label for="radio1" className="d-block me-3">
          <Input id="radio1" type="radio" name="radio1" defaultValue="option1" className="radio-tertiary" />
          Option 1
        </Label>
      </FormGroup>
    ),
  ...
  },
  {
    ...
    tableColData: (
      <FormGroup className="m-b-0 d-flex">
        <Label for="radio44" className="d-block me-3">
          <Input id="radio44" type="radio" name="radio1" defaultValue="option1" className="radio-tertiary" defaultChecked />
          Checked
        </Label>
      </FormGroup>
    ),
  ...
  },
  {
    ...
    tableColData: (
      <FormGroup className="m-b-0 d-flex">
        <Label for="radio33" className="d-block me-3">
          <Input id="radio33" type="radio" name="radio1" defaultValue="option1" className="radio-tertiary" disabled />
          Disabled
        </Label>
      </FormGroup>
    ),
  ...
  },
  {
    ...
    tableColData: (
      <FormGroup className="m-b-0">
        <Label for="radioinline1" className="d-inline-block me-3">
          <Input id="radioinline1" type="radio" name="radio1" className="radio-tertiary" defaultValue="option1" />
          Option 1
        </Label>
        <Label for="radioinline2" className="d-inline-block me-3">
          <Input id="radioinline2" type="radio" className="radio-success" name="radio1" defaultValue="option1" />
          Option 1
        </Label>
        <Label for="radioinline3" className="d-inline-block me-3">
          <Input id="radioinline3" type="radio" className="radio-info" name="radio1" defaultValue="option1" />
          Option 1
        </Label>
      </FormGroup>
    ),
...
export const badgeTableData = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        code: ".badge-* primary , secondary , success , info, warning, danger, light",
      },
...
export const tooltipTableData = [
  {
    title: "Hover",
    tableColData: (
      <Button color="primary" data-original-title="btn btn-link btn-lg" title="Hover">
        Primary
      </Button>
    ),
    details: [
