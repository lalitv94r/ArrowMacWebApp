...
import { AddRowsTable, DeleteRowData, DeleteRowDataProp, TableActionTypes, ZeroConfigurationTableColumnsType } from "@/Type/Tables/DataTables/DataTables";
  ...
  export const deleteRowDataList = [
    {
      ...
      date: "2008/11/28",
      priority: <Badge className="badge-light-danger" color="transparant">Urgent</Badge>,
      budget: "$162.700,00",
      action: "tr-1"
    },
    {
      ...
      date: "2009/10/09",
      priority: <Badge className="badge-light-success" color="transparant">Low</Badge>,
      budget: "$1.200.000,00",
      action: "tr-2"
    },
    {
      ...
      date: "2012/10/13",
      priority: <Badge className="badge-light-primary" color="transparant">High</Badge>,
      budget: "$132.000,00",
      action: "tr-3"
    },
    {
      ...
      date: "2011/05/03",
      priority: <Badge className="badge-light-warning" color="transparant">Medium</Badge>,
      budget: "$163.500,00",
      action: "tr-4"
    },
    {
