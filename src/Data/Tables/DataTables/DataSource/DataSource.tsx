...
import { AjaxSourcedColumnsInterface, CustomCellInterFaces, HtmlColumnsInterface, ServerSideProcessingColumnsInterface } from "@/Type/Tables/DataTables/DataTables";
...
export const htmlColumnData = [
  {
    ...
    cv: (
      <div className="action">
        <Link className="pdf" onClick={handlePDFClick} rel="/assets/images/favicon.png" href="/assets/pdf/sample.pdf" target="_blank">
