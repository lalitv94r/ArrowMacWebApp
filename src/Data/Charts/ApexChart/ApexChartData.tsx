...
export const barChartData: ApexOptions = {
  ...
  plotOptions: {
    bar: {
      isDumbbell: true,
      columnWidth: 3,
      dumbbellColors: [[primary, secondary]],
    },
  },
  legend: {
    show: false,
...
export const bubbleChartData: ApexOptions = {
  ...
  colors: [primary, secondary, "#FD7E40", "#2E8DD3"],
};
...
export const pieChartData: ApexOptions = {
  ...
  colors: [primary, secondary, "#FD7E40", "#2E8DD3", "#17A600"],
};
...
export const donutChartData: ApexOptions = {
  ...
  colors: [primary, "#FD7E40", "#2E8DD3", secondary, "#C42A02"],
};
...
export const mixChartData: ApexOptions = {
  ...
  colors: [primary, secondary, "#FD7E40"],
};
...
export const radarChartData: ApexOptions = {
  ...
  yaxis: {
    ...
    show: false, // Move the 'show' property here
  },
  xaxis: {
...
export const circleChartData: ApexOptions = {
  ...
  colors: ["#FD7E40", primary, "#2E8DD3", secondary, "#C42A02"],
};

export const pyramidChartData: ApexOptions = {
  series: [
    {
      name: "",
...
export const polarChartData: ApexOptions = {
  ...
  colors: [primary, secondary, "#FD7E40", "#2E8DD3", primary, secondary, "#FD7E40", "#2E8DD3"],
  responsive: [
    {
      breakpoint: 480,
      options: {
