...
const tertiary = "#56FDFF";
const success = "#17A600";
...
const GetBubbledData = (min:number, max:number) => {
  let results = [];
  min = Math.floor(Math.random() * (35 - 27 + 1)) + 27;
  max = Math.floor(Math.random() * (85 - 74 + 1)) + 74;
  for(let i=1; i<=12; i++) {
...
export const liveProductChart: ApexOptions = {
  series: [
      {
        name: "Fatty Lever",
        data: GetBubbledData(2600, 7700),
      },
      {
        name: "Constipation",
        data: GetBubbledData(20, 27),
      },
      {
        name: "Gas & Acidity",
        data: GetBubbledData(30, 60),
      },
      {
        name: "Weight management",
        data: GetBubbledData(40, 65),
      },
      {
        name: "Piles",
        data: GetBubbledData(15, 22),
      },
      {
        name: "Hair fall",
        data: GetBubbledData(30, 35),
      },
      {
        name: "Sexual issues",
        data: GetBubbledData(8, 14),
      },
      {
        name: "Skin",
        data: GetBubbledData(35, 55),
      },
      {
        name: "Vitamins deficiency",
        data: GetBubbledData(12, 18),
      },
      {
        name: "IBS",
        data: GetBubbledData(16, 20),
      },
    ],
  chart: {
    height: 400,
  ...
  colors: [primary, secondary, tertiary, success, warning, info, danger, dark, light],
...
export const consultationCount: ApexOptions = {
  chart: {
    toolbar: {
      show: false,
    },
  ...
  series: [
    {
      data: [170, 260, 182, 280, 160, 190, 270, 120, 350, 160, 210, 170, 260, 182, 280, 160, 90, 170, 120, 250, 360, 20, 270, 260, 182, 80, 60, 190, 170, 120, 350, 60],
    },
  ],
  tooltip: {
    x: {
...
export const turnOverChart: ApexOptions = {
  ...
  series: [
    {
      data: [7700, 3600, 8820, 5000, 6000, 2900, 7000, 1200, 5000, 6000, 3500],
    },
  ],
  tooltip: {
    x: {
