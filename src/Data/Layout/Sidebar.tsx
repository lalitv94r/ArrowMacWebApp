    ...
    Items: [
      {
        ...
        active: false,
        children: [
          { path: '/groups', type: "link", title: "Group List" },
          { path: '/groups/entry', type: "link", title: "Create Group" },
        ]
      },
      {
        title: "Permissions",
      ...
      },
      {
        ...
        active: false,
        children: [
          { path: '/user', type: "link", title: "Users List" },
          { path: '/user/entry', type: "link", title: "Create User" },
        ]
      }
    ]
  },
