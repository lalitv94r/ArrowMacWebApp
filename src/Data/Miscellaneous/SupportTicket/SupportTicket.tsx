...
import { ImageDataProp, SkillsDataProp, SupportDataType } from "@/Type/Miscellaneous/SupportTicket/SupportTicket";
...
const SkillsData: React.FC<SkillsDataProp> = ({ value, skillColor }) => {
  return (
    <div className="progress-showcase" style={{ width: "86px" }}>
      <Progress value={value} color={skillColor} style={{ height: "8px" }} />
    </div>
  );
};
