import { AllMemberType, ChatSliceType, ChatsTypes } from "@/Type/Application/Chat/ChatType";
...
export const { setChats, setSelectedUser, fetchChatMemberAsync, changeChat, createNewChatAsync, fetchChatAsync, sendMessageAsync, replyByUserAsync ,searchMember } = ChatSlice.actions;
